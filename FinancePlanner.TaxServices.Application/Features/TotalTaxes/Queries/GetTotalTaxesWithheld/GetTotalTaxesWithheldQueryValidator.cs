...
public class GetTotalTaxesWithheldQueryValidator : AbstractValidator<GetTotalTaxesWithheldQuery>
{
    public GetTotalTaxesWithheldQueryValidator(IConfiguration configuration)
    {
