...
public class GetStateTaxWithheldQueryValidator : AbstractValidator<GetStateTaxWithheldQuery>
{
    public GetStateTaxWithheldQueryValidator(IConfiguration configuration)
    {
